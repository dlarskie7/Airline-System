  ...
  <div class="conatiner">
    ...
    <section class="classes">
      <div class="classes-description">
        ...
        <h3>The higher we soar, the smaller we appear to those who cannot fly.</h3>
      </div>
      <div class="videos">
        <div class="pilates">
          <h3>Pilates</h3>
    ...
    <section class="about">
      <div class="our-story">
        <h2>About Us</h2>
        <p>
        Hello, I'm Gerald Ibina. Passionate about exploration and broadening my horizons, I find joy in traveling and immersing myself in diverse cultures. When not on a new adventure, you'll likely find me on the basketball court, embracing the teamwork and thrill of the game. Looking forward to connecting and sharing experiences with like-minded individuals!
        </p>
      </div>
